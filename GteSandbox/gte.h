...
/* GTE Sprite Routines */
extern pascal void GTECreateSpriteStamp(Word spriteID, Word vBuffAddr) inline(0x0FA0, dispatcher);
extern pascal void GTEAddSprite(Word spriteSlot, Word x, Word y, Word vBuffAddr) inline(0x10A0, dispatcher);
...
/* GTE Tile Routines */
extern pascal void GTELoadTileSet(Ptr tileSetPtr) inline(0x0EA0, dispatcher);
...
extern pascal void GTESetPalette(Word palNum, Ptr palettePtr) inline(0x16A0, dispatcher);
